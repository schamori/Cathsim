"""
Test AAA001 phantom with catheter starting at iliac_left and goal at end of abdominal aorta
"""
...
# Create environment with AAA001 phantom
...
task_kwargs = dict(
    ...
    use_segment=False,
    image_size=64,
    phantom="AAA001",  # Use AAA001 phantom
...
print("Creating environment with AAA001 phantom...")
print(f"  - Phantom: AAA001")
...
original_initialize = task.initialize_episode
